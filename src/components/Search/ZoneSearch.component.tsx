  ...
  const removeProperty = (id: number) => {
    ...
    return (
        ...
        <Container minWidth="100%" padding="0">
            <Text width="70%" margin="10px auto" fontSize="15px" fontWeight="700" lineHeight="20px" textAlign="center" color="#1D467C">Encontrá tu lugar en cualquiera de nuestros países</Text>
