...
export default function Reducer (state: State = {
  ...
  switch (action.type) {
    ...
    case 'GET_' + ENTITY.ENTITY_MAYUS_PLURAL + '_BY_POSTID_WITH_AUHT_PENDING': {
    ...
    case 'GET_' + ENTITY.ENTITY_MAYUS_PLURAL + '_BY_POSTID_WITH_AUHT_REJECTED': {
    ...
    case 'GET_' + ENTITY.ENTITY_MAYUS_PLURAL + '_BY_POSTID_WITH_AUHT_FULFILLED': {
    ...
    case 'GET_' + ENTITY.ENTITY_MAYUS + '_WITH_AUHT_PENDING': {
    ...
    case 'GET_' + ENTITY.ENTITY_MAYUS + '_WITH_AUHT_REJECTED': {
    ...
    case 'GET_' + ENTITY.ENTITY_MAYUS + '_WITH_AUHT_FULFILLED': {
